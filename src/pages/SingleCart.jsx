    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            <View style={styles.mainContainer}>
                <Image source={{ uri: item.imageUri || item.url }} style={styles.productImage} />
                ...
                <TouchableOpacity style={styles.buttonContainer2} onPress={() => console.log('Product Added')}>
                    <Text style={styles.addToCart} onPress={handlePayment}>Add To Cart</Text>
                </TouchableOpacity>
